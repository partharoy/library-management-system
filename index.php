...
<!--                login form-->
                <form action="" method="post">
                    ...
                    <h1>Login Form</h1>
                    <h2 class="text-danger"><?php if (isset($msg)) {echo $msg;} ?></h2>
                    <div>
                    ...
                    <div>
                        <input type="submit" value="Log in" class="btn btn-primary submit" name="btn" >
<!--                        <a class="btn btn-primary submit" type="submit" name="btn" href="">Log in</a>-->
