 ...
 */
    ...
    if (isset($_GET['status'])){
        if ($_GET['status']=='logout'){
            require 'classes/logout_admin.php';
            $obj_logout_admin=new Logout_admin();
            $obj_logout_admin->logout();
        }
}
...
<!-- Flot plugins -->
<script src="assets/src/js/flot/jquery.flot.orderBars.js"></script>
<script src="assets/src/js/flot/date.js"></script>
<script src="assets/src/js/flot/jquery.flot.spline.js"></script>
<script src="assets/src/js/flot/curvedLines.js"></script>
<!-- JQVMap -->
<script src="assets/vendors/jqvmap/dist/jquery.vmap.js"></script>
<script src="assets/vendors/jqvmap/dist/maps/jquery.vmap.world.js"></script>
<script src="assets/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js"></script>
<!-- bootstrap-daterangepicker -->
<script src="assets/src/js/moment/moment.min.js"></script>
<script src="assets/src/js/datepicker/daterangepicker.js"></script>
